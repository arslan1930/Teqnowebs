<div style="padding-top:7rem;padding-bottom:4rem;">
  <div class="wrap" style="max-width:28rem;">
    <div class="card-soft">
      ...
      <p class="muted" style="font-size:.875rem;">Internal tools for Attendance and Ops. Seed password <strong>teqnowebs123</strong>.</p>
      <?php if ($msg = flash('error')): ?><div class="alert alert-err"><?= e($msg) ?></div><?php endif; ?>
      <form class="form" method="post" action="<?= e(url('/login')) ?>">
        <?= csrf_field() ?>
        <label>Email<input type="email" name="email" required value="admin@teqnowebs.com"></label>
