...
/**
 * Plain PHP .env loader (no Composer).
 * Loads project-root .env into putenv / $_ENV / $_SERVER once.
 */
function load_env(?string $path = null): void
{
    ...
    foreach ($lines as $line) {
        ...
        // Do not overwrite real server/OS env
...
function env(string $key, mixed $default = null): mixed
{
    ...
    // Empty string is valid (e.g. DB_PASSWORD=)
    if ($value === '') {
        return '';
    }
...
/** Required .env key. Empty string allowed when $allowEmpty is true (DB_PASSWORD). */
