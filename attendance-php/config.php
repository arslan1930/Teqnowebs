...
$config = [
    'app_name' => (string) env('APP_NAME', 'Teqnowebs Attendance'),
    'app_url' => rtrim((string) env('APP_URL', 'http://localhost/attendance'), '/'),
    'debug' => env_bool('APP_DEBUG', false),
    'timezone' => (string) env('APP_TIMEZONE', 'Asia/Karachi'),

    'db_driver' => $driver,
    'sqlite_path' => __DIR__ . '/storage/attendance.sqlite',

    'mysql' => [
        'host' => $driver === 'mysql' ? env_required('DB_HOST') : (string) env('DB_HOST', 'localhost'),
        'port' => (string) env('DB_PORT', '3306'),
        'database' => $driver === 'mysql' ? env_required('DB_DATABASE') : (string) env('DB_DATABASE', 'attendance'),
